...
def log_info(event_name, details=""):
    logger.info(f"Event info: {event_name} | Details: {details}")

def log_warning(event_name, details=""):
    logger.warning(f"Event warning: {event_name} | Details: {details}")

def log_error(event_name, details=""):
    logger.error(f"Event error: {event_name} | Details: {details}")
